<template>
  <header>  
    ...
    <div class="flex w-full relative text-gray-400 mx-auto bg-black px-4 sm:px-0">
      <div class="container w-full mx-auto flex items-center flex-wrap">  
        <div class="w-full md:w-6/12 sm:w-3/12 lg:w-2/12 my-5 mx-2">
        <a href="/">
          <span>
           <g-image
    ...
    ></g-image>
        ...
        <div class="w-full md:w-5/12 md:w-9/12">
          <div class="flex-1 text-gray-500 text-xs text-center  pt-1">
            <HeaderNavigation/>
          </div>
        </div>
      </div>
